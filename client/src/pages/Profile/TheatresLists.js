...
import { GetAllTheatres, DeleteTheatre, GetAllTheatresByOwner } from "../../apicalls/theatres"
import Shows from "./Shows"

function TheatreList() {
    const { user } = useSelector(state => state.users)
    const [showMovieFormModal = false, setShowMovieFormModal] = useState(false);
    const [selectedTheatre = null, setSelectedTheatre] = useState(null);
    const [formType = "add", setFormType] = useState("add");
    const [id, setid] = useState('')
    const [ShowTheatreFormModal, setShowTheatreFormModal] = useState('')
    ...
    return (
        <div>
            ...
            {setShowTheatreFormModal && <TheatreForm
                showMovieFormModal={showMovieFormModal}
                setShowTheatreFormModal={setShowMovieFormModal}
                formType={formType}
